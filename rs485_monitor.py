...
APP_VERSION = "0.5"   # bump this each time I hand you a new file
...
class SerialMonitorApp:
    ...
    def _draw_graph(self):
        ...
        to. Does NOT reschedule itself - call directly for an immediate
        redraw (e.g. a checkbox toggled), or via _update_graph() on the
        timer."""
