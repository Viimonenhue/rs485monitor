...
APP_VERSION = "0.13"   # bump this each time I hand you a new file
...
class SerialMonitorApp:
    ...
    def _open_settings_dialog(self):
        ...
        ttk.Label(frame, text="Movement Direction Indicator", font=("Segoe UI", 11, "bold")).pack(anchor="w")
        ttk.Label(frame,
    ...
    def _build_graph_tab(self, notebook):
        ...
        direction_row = ttk.Frame(graph_tab)
        direction_row.pack(side="top", fill="x", padx=5, pady=(0, 5))
        ttk.Label(direction_row, text="Movement direction indicator:", font=("Segoe UI", 9, "bold")).pack(
            side="left", padx=(0, 6))
        direction_combo = ttk.Combobox(direction_row, textvariable=self.direction_mode_var, width=26,
    ...
    def _compute_direction_runs(self):
        ...
        EPS = 0.3  # degrees per step; ignores jitter below this
