...
APP_VERSION = "0.8"   # bump this each time I hand you a new file
    ...
    def _draw_graph(self):
        ...
        try:
            ...
            for pos, i in enumerate(checked):
                ...
                # Cap every axis - primary and each twin - to at most 10
                # tick labels. Without this, a wide/odd range (like Encoder
                # degrees) can generate dozens of overlapping labels that
                # visually look like solid bars.
